...
namespace TechParamsCalc.DataBaseConnection.Density
{
    public class DensityContent
    {
        //Class with density content description (reading from PostgreSQL DB)
        ...
        public string description { get; set; }     //Description of density tag
